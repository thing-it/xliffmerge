  ...
  private doSerializeToString(
    ...
    switch (node.nodeType) {
      case node.ELEMENT_NODE:
        ...
        const elementHasMixedContent = this.isMixedContentElement(
          nodeName,
          options
        );
        ...
        if (child) {
          ...
          while (child) {
            ...
            this.doSerializeToString(
              ...
              buf,
              indentLevel + 1,
              partOfMixedContent || elementHasMixedContent,
              visibleNamespaces
            );
      ...
      case node.TEXT_NODE:
        ...
        if (
          !options.beautify ||
          partOfMixedContent ||
          !this.containsOnlyWhiteSpace(textNode.data)
        ) {
